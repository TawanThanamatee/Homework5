...
namespace Homework5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string inputFileimage = Console.ReadLine(); //C:\Users\Pai\source\repos\Homework5\test.txt\InputImage.txt
            //InputFile
        ...
        static double[,] Convolve (double[,] repeated_textureArray , double[,] convolutionKernelArray)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                for (int j = 0; j < 5; j++)
                {
                    ...
                    dataFileOutputArray[i, j] = (repeated_textureArray[repeated_Row1, repeated_column1] * convolutionKernelArray[0, 0]) + (repeated_textureArray[repeated_Row1, repeated_column2] * convolutionKernelArray[0, 1]) + (repeated_textureArray[repeated_Row1, repeated_column3] * convolutionKernelArray[0, 2])
                        + (repeated_textureArray[repeated_Row2, repeated_column1] * convolutionKernelArray[1, 0]) + (repeated_textureArray[repeated_Row2, repeated_column2] * convolutionKernelArray[1, 1]) + (repeated_textureArray[repeated_Row2, repeated_column3] * convolutionKernelArray[1, 2])
                        + (repeated_textureArray[repeated_Row3, repeated_column1] * convolutionKernelArray[2, 0]) + (repeated_textureArray[repeated_Row3, repeated_column2] * convolutionKernelArray[2, 1]) + (repeated_textureArray[repeated_Row3, repeated_column3] * convolutionKernelArray[2, 2]);
